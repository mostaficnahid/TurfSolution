try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "2845cb58-924b-488d-b313-f6a7789d7f8f", e._sentryDebugIdIdentifier = "sentry-dbid-2845cb58-924b-488d-b313-f6a7789d7f8f")
} catch (e) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2597], {
        7119: (e, t, r) => {
            ...
            var l = r(65547);
            let a = (0, l.createServerReference)("40bb8c5f919efd5048ad7ced335d3a2185972acc7c", l.callServer, void 0, l.findSourceMapURL, "getProjectDetail")
        },
        9101: (e, t, r) => {
            r.d(t, {
                p: () => m,
        ...
        28151: (e, t, r) => {
            ...
            var l = r(72011),
                ...
                d = r(3417),
                u = r(65547);
            let p = (0, u.createServerReference)("4013fe57be51d9a348bb568e5640fd5cd75d05e44c", u.callServer, void 0, u.findSourceMapURL, "createShortlink");
            var m = r(80992),
                x = r(27743),
                f = r(37600),
                h = r(89498);
            let g = e => {
                    let {
                        ...
                        user: j
                    } = (0, c.J)(), [v, b] = (0, n.useState)(!1), [w, _] = (0, n.useState)(null), y = t.visibility === m.wg.PUBLIC, k = (() => {
                        let e = "".concat((0, x.getProjectOrigin)()).concat(t.project_url, "?enter_from=share");
                        return u ? "".concat(e, "&invite_code=").concat(u) : e
                    })(), N = (0, n.useRef)(!0), [C, S] = (0, n.useState)(!1), U = (null == j ? void 0 : j.plan) === "Free" || !j || !j.plan, R = (0, d.useRouter)();
                    (0, n.useEffect)(() => {
                        N.current && (N.current = !1, g("share_pop_up_show", {
                    ...
                    let I = () => C && w ? w : k,
                        L = async () => {
                            if (U) return void R.push("/subscription");
                            if (w) return void S(!C);
                            if (v) return;
                            b(!0);
                            let e = k + "&screen_status=1",
                                t = await p(e);
                            t.success && t.shortUrl ? (console.log("create short link success", t), _(t.shortUrl)) : (console.log("create short link error", t), (0, f.P)({
                        ...
                        children: [(0, l.jsxs)("div", {
                            ...
                            children: [(0, l.jsxs)("div", {
                                ...
                                onClick: () => {
                                    ...
                                    navigator.clipboard.writeText(n), (0, f.P)({
                                        message: y ? "Link copied to clipboard" : "Link and passcode copied to clipboard",
                                        type: "success",
                                        icon: !y && (0, l.jsx)(a.XJr, {
                                            className: "h-4 w-4 text-[#14AE5C]"
                                        })
                                    }), g("share_copy_link_click", {
                                        project_id: t.project_id,
                                        project_url: t.project_url,
                                        location: s,
                                        is_public: +!!y,
                            ...
                            children: [(0, l.jsxs)("button", {
                                ...
                                children: [v ? (0, l.jsx)(a.GJV, {
                                    ...
                                    className: (0, h.cn)("bg-brand ml-0.5 flex h-[18px] w-[41px] cursor-pointer items-center justify-center gap-[3px] rounded-[6px] text-[10px] text-white"),
                ...
                j = e => {
                    let {
                        ...
                        let e = "".concat((0, x.getProjectOrigin)()).concat(t.project_url);
                        return p ? "".concat(e, "?invite_code=").concat(p) : e
                    })(), f = null != o ? o : m, h = t.custom_title || t.title || "", [g, j] = (0, n.useState)(!1), [v, b] = (0, n.useState)(!1), w = (0, n.useRef)(null);
                    return (0, n.useEffect)(() => {
                        let e = () => {
                                let e = w.current;
                                e && (j(e.scrollLeft > 0), b(e.scrollLeft < e.scrollWidth - e.clientWidth - 1))
                            },
                            t = w.current;
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: [(0, l.jsx)("div", {
                                ...
                                children: [(0, l.jsx)("div", {
                                    ...
                                    onClick: () => {
                                        w.current && (w.current.scrollLeft -= 200)
                                    },
                ...
                v = e => {
                    let {
                        ...
                        return (0, l.jsx)("div", {
                            className: (0, h.cn)("flex h-[120px] w-[120px] flex-shrink-0 items-center justify-center rounded-[12px] border border-black/6"),
            ...
            let w = [{
                ...
                _ = (0, u.createServerReference)("60c37378e0ced946fadeabf064b8d0080416be701f", u.callServer, void 0, u.findSourceMapURL, "genShareUrl"),
                y = (0, u.createServerReference)("4073077f21bce53caf0622378a8facc460ae25971a", u.callServer, void 0, u.findSourceMapURL, "getShareTemplateList"),
                k = (e, t, r) => {
                    ...
                    (0, n.useEffect)(() => {
                        (async () => {
                            if (!(l.length > 0)) try {
                                let t = await y(e);
                                0 === t.code && t.data ? a(t.data.templates) : b.vF.info("get share template list failed", t)
                            } catch (e) {
                                b.vF.error("fetch templates error", e)
                            }
                        })()
                    }, []);
                ...
                N = e => {
                    let {
                        ...
                        track: f
                    } = (0, i.s)(), g = new URL("".concat((0, x.getProjectOrigin)()).concat(t.project_url));
                    g.searchParams.set("type", "card"), o && g.searchParams.set("invite_code", o);
                    let v = async () => {
                        if (p) try {
                            var e;
                            ...
                            b.vF.error("Save image failed:", e)
                        }
                    };
                    return (0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: (0, l.jsx)("div", {
                                ...
                                children: d.map(e => (0, l.jsx)("div", {
                                    className: (0, h.cn)("flex h-[80px] w-[80px] cursor-pointer items-center justify-center rounded-[12px] border border-black/6", (null == u ? void 0 : u.template_id) === (null == e ? void 0 : e.template_id) ? "border-brand border-2" : ""),
                                    onClick: () => e && m(e),
                                    children: (0, l.jsx)("img", {
                                        src: e.template_icon,
                                        alt: " ",
                            ...
                            onTrack: e => {
                                f("share_card_to_social_platform_click", { ...e,
                                    project_id: t.project_id,
                ...
                S = e => {
                    ...
                    let {
                        ...
                        userId: j
                    } = (0, c.J)(), v = (null == (t = r.user) ? void 0 : t.uid) === j;
                    return (0, n.useEffect)(() => {
                        j && h()
                    }, [j]), (0, l.jsxs)("div", {
                        className: "fixed inset-0 z-50 flex items-center justify-center bg-black/20",
        ...
        52423: (e, t, r) => {
            ...
            var l = r(65547);
            let a = (0, l.createServerReference)("406c06707e228583914f911e2f519980959826baa5", l.callServer, void 0, l.findSourceMapURL, "checkSlugPrefix")
        },
        80992: (e, t, r) => {
            r.d(t, {
                Ks: () => a,
