try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "ded96a49-b400-4020-a8f0-94751ad2432f", e._sentryDebugIdIdentifier = "sentry-dbid-ded96a49-b400-4020-a8f0-94751ad2432f")
} catch (e) {}
"use strict";
    ...
    [7070], {
        ...
        87070: (e, t, r) => {
            ...
            var l = r(74655),
                ...
                c = r(73787),
                u = r(65547);
            let g = (0, u.createServerReference)("702d461778ffa163781a714e1a35a8529bb2490ea9", u.callServer, void 0, u.findSourceMapURL, "innerRequest");
            var h = r(9101);
            ...
            var I = r(33686),
                b = r(93392),
                E = r(23914);
            let T = (0, u.createServerReference)("40f48e0845751cc999206eeed4ee1dcdaae21be0b8", u.callServer, void 0, u.findSourceMapURL, "getProjectUserInfo");
            var R = r(92394),
                _ = r(11825),
                x = r(86881),
                A = r(63640),
            ...
            let M = (0, R.tZ)("Fetch Monitor"),
                O = (0, u.createServerReference)("4037977159e6d162e29d8bbf48a0e47db09c9bf964", u.callServer, void 0, u.findSourceMapURL, "getUserTokenForAIProject");
            ...
            class D {
                static async fetchToken(e) {
                    ...
                    if (0 !== n.code) throw P.error("Failed to fetch token", {
                        projectId: e,
                        error: n.message || "Unknown error"
                    }), Error("Failed to fetch token: ".concat(n.message || "Unknown error"));
                    if (!(null == (t = n.data) ? void 0 : t.token) || !(null == (r = n.data) ? void 0 : r.expires_in)) throw P.error("Invalid token response", {
                        projectId: e,
            ...
            let P = (0, R.tZ)("LLMToken");
            class L {
                async getToken() {
                    if (this.isDestroyed) throw new j("TokenManager has been destroyed", "DESTROYED");
                    if (this.tokenInfo && this.tokenInfo.expiresTime > Date.now()) return this.tokenInfo.token;
                    if (this.refreshPromise || (this.refreshPromise = this.refreshToken()), await this.refreshPromise, !this.tokenInfo) throw new j("Failed to obtain token", "FETCH_FAILED");
                ...
                async refreshToken() {
                    ...
                    if (!this.isDestroyed) {
                        ...
                        try {
                            P.trace("Refreshing llm-token", {
                                projectId: this.config.projectId
                            });
                            let e = await this.tokenFetcher(this.config.projectId);
                            if (!e.token || !e.expires_in) throw new j("Invalid token response", "INVALID_RESPONSE", !0);
                            this.tokenInfo = {
                                token: e.token,
                                expiresTime: Date.now() + 1e3 * e.expires_in - 5e3
                            }, this.scheduleNextRefresh(e.expires_in), this.refreshPromise = null, P.trace("llm-token refreshed successfully", {
                                projectId: this.config.projectId,
                            ...
                            if (this.isRetryableError(t) && e < this.config.retryConfig.maxAttempts) {
                                ...
                                if (P.error("Retrying llm-token fetch (attempt ".concat(e + 1, "/").concat(this.config.retryConfig.maxAttempts, ") in ").concat(r, "ms"), {
                                        projectId: this.config.projectId,
                                        error: t
                                    }), await new Promise(e => {
                                ...
                                let r = t instanceof Error ? t.message : String(t),
                                    n = new j("Failed to fetch token after ".concat(e + 1, " attempts: ").concat(r), "MAX_RETRIES_EXCEEDED");
                                throw P.error("Failed to fetch token after ".concat(this.config.retryConfig.maxAttempts, " attempts"), n, {
                                    projectId: this.config.projectId,
                                    originalError: t
                                }), n
                            }
                ...
                isRetryableError(e) {
                    return e instanceof j ? e.retryable : !(e instanceof Error) || e.message.includes("network") || e.message.includes("timeout") || e.message.includes("fetch")
                }
            ...
            let q = {
                ...
                U = (0, c.forwardRef)((e, t) => {
                    let {
                        ...
                        style: z,
                        ...J
                    } = e, K = (0, c.useRef)(null), [Z, V] = (0, c.useState)(() => Date.now()), [G, Q] = (0, c.useState)(!0), {
                        track: $
                    ...
                    ! function(e) {
                        ...
                        requestLogin: async e => new Promise((t, r) => {
                            el() ? t({
                                ...
                                onConfirm: () => {
                                    let e = (0, C.getOrigin)() + window.location.pathname + window.location.search;
                                    eo.push("".concat((0, C.getOrigin)(), "/login?returnTo=").concat(encodeURIComponent(e))), ef.current = e => {
                                        e ? t({
                                            isLoggedIn: !0
                    ...
                    function(e) {
                        ...
                        innerRequest: async (e, t) => {
                            N.info("innerRequest", {
                                ...
                                el() ? e(!0) : (0, _.S)({
                                    ...
                                    onConfirm: () => {
                                        let r = (0, C.getOrigin)() + window.location.pathname + window.location.search;
                                        eo.push("".concat((0, C.getOrigin)(), "/login?returnTo=").concat(encodeURIComponent(r))), ef.current = r => {
                        ...
                        let e = {
                            getIframe: () => K.current,
                            getIframePosition: () => K.current ? K.current.getBoundingClientRect() : null,
                            refresh: () => {
                                Q(!0), V(Date.now())
                            }
                        };
                    ...
                    let {
                        ...
                        return (0, c.useEffect)(() => (u.current = new L({
                            ...
                            getToken: (0, c.useCallback)(async () => {
                                if (!u.current) throw new j("TokenManager not initialized", "NOT_INITIALIZED");
                                a(!0), d(null);
                                try {
                                    return await u.current.getToken()
                                } catch (t) {
                                    let e = t instanceof j ? t : new j(t instanceof Error ? t.message : String(t), "UNKNOWN_ERROR");
                                    throw d(e), e
                                } finally {
                                    a(!1)
                                }
                        ...
                        let e = function(e) {
                                ...
                                N.info("getToken", {
                                    ...
                                    el() ? e(!0) : (0, _.S)({
                                        ...
                                        onConfirm: () => {
                                            let t = (0, C.getOrigin)() + window.location.pathname + window.location.search;
                        ...
                        return ! function(e) {
                            ...
                            a = t, t.onInvoke("fetch-proxy:fetch", async e => {
                                ...
                                try {
                                    ...
                                    if ((null == n ? void 0 : n.afterResponse) && await n.afterResponse(f), h.body) {
                                        let r = h.body.getReader();
                                        i.set(e.requestId, {
                                            reader: r,
                                            abortController: g,
                                            chunks: [],
